...
const contarCaracteres = function (cadena) {
    if (cadena === null) {
        console.log('Escriba una cadena, por favor')
...
const recortarCaracteres = function (cadena, cantidad) {
    if (isNaN(cantidad)) {
        console.log('Por favor la cantidad no puede ir vacia')
...
const almacenarCaracteresArray = function (cadena) {
    if (cadena === null) {
...
const repetirCaracteres = function (cadena, cantidad) {
    let repetirCadena = ''
    if (isNaN(cantidad)) {
